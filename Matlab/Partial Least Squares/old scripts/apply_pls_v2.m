function apply_pls_v2(file_input, file_output)
load pretreatment_list.mat
%eval(['load' file_input ';']);
load(file_input)
% load(file_vettore)#si attiva con cross-val di tipo custom
...
results.pret_list = [181:215, 227:248, 260:281, 293:325, 337:358, 360:394, 406:427, 439:460, 472:504, 516:537];
...
for i = results.pret_list
    ...
    % modelcv = crossval(Xcalp, Ycalp, model, CV8_CV, LVs, optionscv);
